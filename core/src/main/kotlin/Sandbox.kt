...
object Sandbox {
    ...
    object RewriteBytecode {
        ...
        internal val checkMethodName = RewriteBytecode::checkException.javaMethod?.name
            ?: error("should have a method name")
        internal val checkMethodDescription = Type.getMethodDescriptor(RewriteBytecode::checkException.javaMethod)
        ...
        internal val syncNotifyMethods = mapOf(
        ...
        internal fun rewrite(
            ...
            val sandboxingVisitor = SandboxingClassVisitor(
                unsafeExceptionClasses,
                blacklistedMethods,
                allPreinspections,
                context,
