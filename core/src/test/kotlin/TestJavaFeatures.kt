...
class TestJavaFeatures : StringSpec() {
    override suspend fun beforeSpec(spec: Spec) {
        seenJavaFeatures.clear()
        watchJavaFeatures = true
    }
...
"""
        ...
        "should count final and abstract methods and records" {
            Source.fromJavaSnippet(
                """
...
"""
                ...
                featureMap[FeatureName.RECORD] shouldBe 1
                featureList should haveFeatureAt(FeatureName.RECORD, listOf(16))
            }
        }
